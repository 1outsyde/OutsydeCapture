        ...
        if (response.ok) {
          ...
          if (backendUser) {
            const updated: User = {
              ...
              avatar: backendUser.profilePhotoUrl || backendUser.avatar || backendUser.profileImageUrl || parsed.avatar,
              profileImageUrl: backendUser.profilePhotoUrl || backendUser.profileImageUrl || parsed.profileImageUrl,
