...
export default function PhotographerProfileScreen() {
  ...
  const handleMessage = async () => {
    ...
    if (__DEV__) {
      console.log("[PhotographerProfile] handleMessage - senderId:", senderId, "photographerAuthUserId:", photographerAuthUserId, "entityId:", photographer.id);
    }
    ...
    try {
      ...
      console.log("[PhotographerProfile] Navigating to conversation:", conversationId);
