  ...
  const loadProfile = useCallback(async () => {
    ...
    try {
      ...
      try {
        ...
        console.log("[TEMP-DIAG][VendorDetail] role-ish fields:", JSON.stringify({ type: (business as any)?.type, role: (business as any)?.role, accountType: (business as any)?.accountType, userType: (business as any)?.userType }));
