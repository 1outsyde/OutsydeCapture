...
interface InviteTeamModalProps {
  ...
  onInviteSent: () => void;
  brandColor?: string;
  seatStatus?: { activeCount: number; maxStaff: number | null; tierName: string } | null;
}
    ...
    <Modal visible={visible} animationType="slide" transparent>
      <View style={styles.overlay}>
        ...
        >
          ...
          >
            {/* Seat cap warning */}
            {seatStatus !== null && seatStatus !== undefined && seatStatus.maxStaff !== null && seatStatus.activeCount >= seatStatus.maxStaff ? (
